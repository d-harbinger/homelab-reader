...
CREATE TABLE "new_InkStroke" (
    ...
    "kind" TEXT NOT NULL DEFAULT 'pen',
...
INSERT INTO "new_InkStroke" ("bookId", "color", "createdAt", "id", "kind", "opacity", "page", "path", "userId", "width") SELECT "bookId", "color", "createdAt", "id", "kind", "opacity", "page", "path", "userId", "width" FROM "InkStroke";
