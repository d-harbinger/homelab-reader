...
INSERT INTO "new_InkStroke" ("bookId", "color", "createdAt", "id", "opacity", "page", "path", "userId", "width") SELECT "bookId", "color", "createdAt", "id", "opacity", "page", "path", "userId", "width" FROM "InkStroke";
